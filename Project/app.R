                         ...
                         fluidRow(
                           column(width = 4,
                             ...
                             radioButtons("decision2", "Introduce feature 2?",
                                          choices = c("Yes" = TRUE, "No" = FALSE), 
                                          selected = character(0)),
                             textInput("surveyquestion2", "Why did you make that decision?", 
                                       value = "")
                           )),
                         ...
                         fluidRow(
                           column(width = 4,
                             ...
                             radioButtons("decision3", "Introduce feature 3?",
                                          choices = c("Yes" = TRUE, "No" = FALSE), 
                                          selected = character(0)),
                             textInput("surveyquestion3", "Why did you make that decision?", 
                                       value = "")
                           )),
                           column(width = 8,
                                  tabBox(width=12,
                         ...
                         fluidRow(
                           column(width = 4,
                             ...
                             radioButtons("decision4", "Introduce feature 4?",
                                          choices = c("Yes" = TRUE, "No" = FALSE), 
                                          selected = character(0)),
                             textInput("surveyquestion4", "Why did you make that decision?", 
                                       value = "")
                           )),
                           column(width = 8,
                                  tabBox(width=12,
                          ...
                          column(width = 4,
                                 box(width=12,
                                     ...
                                     radioButtons("decision5", "Introduce feature 5?",
                                                  choices = c("Yes" = TRUE, "No" = FALSE), 
                                                  selected = character(0)),
                                     textInput("surveyquestion5", "Why did you make that decision?", 
                                               value = "")
                                 )),
                          column(width = 8,
                                 tabBox(width=12,
                          ...
                          column(width = 4,
                                 box(width=12,
                                     ...
                                     radioButtons("decision6", "Introduce feature 6?",
                                                  choices = c("Yes" = TRUE, "No" = FALSE), 
                                                  selected = character(0)),
                                     textInput("surveyquestion6", "Why did you make that decision?", 
                                               value = "")
                                 )),
                          column(width = 8,
                                 tabBox(width=12,
